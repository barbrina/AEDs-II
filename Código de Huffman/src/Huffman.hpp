...
{
    string data;            // One of the input strings
...
{
    int tamanho;         // Tamanho atual da min heap
    int capacidade;      // Capacidade da min heap
...
void procura(MinHeapNode *root, string data, float freq, int arr[], int top, ofstream &outstream);
